...
const stories = [
  ...
  },
  {
    ...
    URL: 'https://storysquad-main.s3.amazonaws.com/pdfs/Story+Squad+Week+2+Content+%2B+CCS.pdf',
    WritingPrompt: "Where would Finn to visit first while wearing his new jersey",
    DrawingPrompt: "Where would Finn to visit first while wearing his new jersey",
  },
  {
    Title: "Zoom & Boom (Week3, Chapters 5 & 6)",
    URL: 'https://storysquad-main.s3.amazonaws.com/pdfs/Story+Squad+Week+3+Content+%2B+CCS.pdf',
  ...
  },
  {
    ...
    URL: 'https://storysquad-main.s3.amazonaws.com/pdfs/Story+Squad+Week+4+CCS+%2B+Instructions.pdf',
    WritingPrompt: "Finn and Gilberts mom was a secret spy. What was her last adventure?",
    DrawingPrompt: "Finn and Gilberts mom was a secret spy. What was her last adventure?",
  },
  // {
  //   Title: "Zoom & Boom (Week5, Chapters 9 & 10)",
  //   URL: 'https://test-image-bucket-14579.s3.amazonaws.com/pdf.pdf',
  //   WritingPrompt: "What went wrong when Finn got his tooth ready for the toothfairy?",
  //   DrawingPrompt: "What went wrong when Finn got his tooth ready for the toothfairy?",
  // },
  // {
  //   Title: "Zoom & Boom (Week6, Chapters 11 & 12)",
  //   URL: 'https://test-image-bucket-14579.s3.amazonaws.com/pdf.pdf',
  //   WritingPrompt: "Finn and Gilbert decide to make the biggest sandwhich possible. What happened next?",
  //   DrawingPrompt: "Finn and Gilbert decide to make the biggest sandwhich possible. What happened next?",
  // },
  // {
  //   Title: "Zoom & Boom (Week7, Chapters 13 & 14)",
  //   URL: 'https://test-image-bucket-14579.s3.amazonaws.com/pdf.pdf',
  //   WritingPrompt: "Gilbert tried to eat an octopus. How did it not go as planned?",
  //   DrawingPrompt: "Gilbert tried to eat an octopus. How did it not go as planned?",
  // },
  // {
  //   Title: "Zoom & Boom (Week8, Chapters 15 & 16)",
  //   URL: 'https://test-image-bucket-14579.s3.amazonaws.com/pdf.pdf',
  //   WritingPrompt: "What does Finn do now that he's the official equipment manager?",
  //   DrawingPrompt: "What does Finn do now that he's the official equipment manager?",
  // },
  // {
